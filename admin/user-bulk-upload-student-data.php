...
<div class="container user-form-container">
    ...
    <a href="assets/format/bora_student.csv" class="download-form-btn">Download Format <ion-icon name="download-outline"></ion-icon></a>
    ...
    <form class="add-user-form" method="POST" action="user-upload-data.php" enctype="multipart/form-data">
        <div class="mb-3">
