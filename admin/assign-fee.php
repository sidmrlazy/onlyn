...
<div class="container user-form-container">
    ...
    <form class="add-user-form" method="POST" action="update-course-fee.php">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="courseSem" disabled placeholder="<?php echo $course_semester_name ?>">
        </div>

        <div class="mb-3">
            <label for="courseSem" class="form-label">Semesters Fee</label>
            <input type="number" name="course_fee" required class="form-control" id="courseSem">
        </div>
