<div class="container section-container mt-5">
    <div class="centered-row">
        <div class="col-md-6 login-background">
            <img src="assets/images/vectors/vec-1.png" alt="">
        </div>
        ...
        <div class="col-md-6 section-form">
            ...
            <form action="" class="mt-4 login-form" method="POST">
                <div class="form-floating mb-3">
                    <input type="number" name="user_contact" class="form-control" id="floatingInput" placeholder="+91 XXXXX XXXXX">
                    <label for="floatingInput">Registered Mobile Number</label>
                </div>

                <div class="form-floating mb-3">
                    <input type="password" autocomplete="on" name="user_password" class="form-control" id="floatingPassword" placeholder="Password">
