    ...
    <div class="school-main-dashboard container mt-3">
        <div class="tab-pill-grid animate__animated animate__fadeIn">
            ...
            <div class="tab-pill">
                <div class="tab-row mb-3">
                    ...
                    <p class="tab-label">You are the class teacher of class
                        <strong><?php echo $class_name . $class_section ?></strong>
                    </p>
                    <?php ?>
                </div>
                <div class="tab-row">
        ...
        <div class="mt-4 animate__animated animate__fadeIn">
            <div class="tab-wrap-view">
                ...
                if ($teacher_id == $session_user_id) {
                    $teacher_name;
                }

                $select_query = "SELECT * FROM time_table WHERE tt_teacher = '$teacher_name'";
