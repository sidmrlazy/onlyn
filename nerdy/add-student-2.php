        ...
        <form action="" method="POST" class="card p-3">
            <div class="w-100 d-flex mob-flex mb-3">
                <div class="w-100 m-1 form-floating">
                    <input type="number" name="student_roll_number" class="form-control" id="floatingInput" placeholder="Roll Number" required>
                    <label for="floatingInput">Roll Number</label>
                </div>
                <div class="w-100 m-1 form-floating">
                    <input type="text" name="student_name" class="form-control" id="floatingInput" placeholder="name@example.com" required>
                    <label for="floatingInput">Student's Full Name</label>
                </div>
            </div>
            <div class="w-100 d-flex mob-flex mb-3">
                <div class="w-100 form-floating m-1 ">
                    <input type="text" name="student_father_name" class="form-control" id="floatingPassword" placeholder="Password" required>
                    <label for="floatingPassword">Father's Name</label>
                </div>
                <div class="w-100 form-floating m-1 ">
                    <input type="number" name="student_father_contact" class="form-control" id="floatingPassword" placeholder="Password" required>
                    <label for="floatingPassword">Father's Mobile Number</label>
                </div>
                <div class="w-100 form-floating m-1 ">
                    <input type="email" name="student_father_email" class="form-control" id="floatingPassword" placeholder="Password">
            ...
            <div class="w-100 d-flex mob-flex mb-3">
                <div class="w-100 form-floating m-1 ">
                    <input type="text" name="student_mother_name" class="form-control" id="floatingPassword" placeholder="Password">
                    <label for="floatingPassword">Mother's Name</label>
                </div>
                <div class="w-100 form-floating m-1 ">
                    <input type="number" name="student_mother_contact" class="form-control" id="floatingPassword" placeholder="Password">
                    <label for="floatingPassword">Mother's Mobile Number</label>
                </div>
                <div class="w-100 form-floating m-1 ">
                    <input type="email" name="student_mother_email" class="form-control" id="floatingPassword" placeholder="Password">
                    <label for="floatingPassword">Mother's Email Address</label>
                </div>
            </div>
            <div class="form-floating mb-3">
                <textarea class="form-control" name="student_address" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" required></textarea>
                <label for="floatingTextarea2">Full Address</label>
            </div>

            <div class="w-100 d-flex mob-flex mb-3">
                <div class="form-floating m-1 w-100">
                    <select class="form-select" name="student_state" id="floatingSelect" aria-label="Floating label select example" required>
                ...
                <div class="form-floating m-1 w-100">
                    <select class="form-select" name="student_city" id="floatingSelect" aria-label="Floating label select example" required>
                ...
                <div class="form-floating m-1 w-100">
                    <input type="number" name="student_pincode" maxlength="6" class="form-control" id="floatingInput" placeholder="XXXXXX" required>
            ...
            ?>
            <input type="text" name="student_assigned_class" value="<?php echo $class_id . " " . $class_name . $class_section ?>" hidden>

            <div class="form-floating mb-3">
                <select class="form-select" name="student_assigned_class" id="floatingSelect" aria-label="Floating label select example">
