    ...
    <div class="school-main-dashboard animate__animated animate__fadeIn">
        ...
        <?php }
            ...
            while ($row = mysqli_fetch_assoc($get_students_res)) {
                ...
                $fetch_result_status = "SELECT * FROM `exam_result` WHERE `exam_result_student_id` = '$student_id' AND `exam_result_exam_id` = '$exam_id'";
                $fetch_result = mysqli_query($connection, $fetch_result_status);
                ...
                if ($fetch_result) {
                    ...
                    while ($row = mysqli_fetch_assoc($fetch_result)) {
                        $exam_result_obt = $row['exam_result_obt'];
