...
<div class="container-fluid dashboard-structure">
    ...
    <div class="school-main-dashboard animate__animated animate__fadeIn">
        ...
        if (isset($_POST['submit'])) {
            ...
            $fetch_exam_query = "SELECT * FROM `exam` WHERE `exam_class_id` = '$class_id'";
        ...
        <form action="edit-teacher-upload-result-3.php" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-3">
                <button type="submit" name="edit" class="btn w-100 btn-success">Continue</button>
            </div>
        </form>
        <?php }
        } ?>
