...
if ($session_selected_lang == '1') {
    ...
    require('components/press-release/section-1-eng.php');
    require('components/press-release/section-2-eng.php');
    require('includes/footer.php');
} else if ($session_selected_lang == '2') {
    $title = "प्रेस रिलीज़ | डॉ नीरज बोरा";
    require('includes/header.php');
    require('includes/navbar-hindi.php');
    require('components/press-release/section-1-hindi.php');
    require('components/press-release/section-2-hindi.php');
