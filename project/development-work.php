...
if ($session_selected_lang == '1') {
    $title = "Development Work | Dr. Neeraj Bora";
    require('includes/header.php');
    require('includes/navbar.php');
    require('components/development/section-1-eng.php');
    require('components/development/section-2-eng.php');
    require('includes/footer.php');
} else if ($session_selected_lang == '2') {
    $title = "विकास कार्य | डॉ नीरज बोरा";
    require('includes/header.php');
    require('includes/navbar-hindi.php');
    require('components/development/section-1-hindi.php');
