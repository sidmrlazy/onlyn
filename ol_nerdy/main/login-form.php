<div class="container section-container mt-5">
    <div class="centered-row">
        <div class="col-md-6 login-background">
            <img src="assets/images/logo/logo.png" alt="" class="login-img">
        </div>
        ...
        <div class="col-md-6 section-form">
            ...
            <form action="" class="card p-5" method="POST">
                ...
                <button type="submit" name="submit" class="login-button w-100">Login</button>

                <div class="line section-form"></div>

                <a href="plan-select.php" class="register-button btn w-100">Register</a>
            </form>
        </div>
    </div>
</div>