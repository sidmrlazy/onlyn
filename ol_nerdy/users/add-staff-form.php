<div class="container section-container mb-5">
    <div class="section-header">
        <h3>Add Staff</h3>
        <p>Mention the details below to add staff in your account</p>
    </div>
    <?php
    ...
    if (isset($_POST['complete'])) {
        ...
        if (!$update_table_result) {
            ...
            echo "<div class='alert alert-success' role='alert'>Staff Addition completed!</div>";
        }
    }
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($insert_staff_result) {
            echo "<div class='alert alert-success' role='alert'>Staff ID generated!</div>";
        } else {
