                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <div class="dropdown-row">
                            <div class="dropdown-section">
                                <ion-icon name="phone-portrait-outline" class="dropdown-icon"></ion-icon>
                                <div>
                                    <a class="dropdown-item" id="dropdown-heading" href=" #">Mobile</a>
                            ...
                            <div class="dropdown-section">
                                <ion-icon name="laptop-outline" class="dropdown-icon"></ion-icon>
                                <div>
                                    <a class="dropdown-item" id="dropdown-heading" href="#">Backend</a>
                        ...
                        <div class="dropdown-row">
                            <div class="dropdown-section">
                                ...
                                <div>
                                    <a class="dropdown-item" id="dropdown-heading" href="#">Frontend</a>
                            ...
                            <div class="dropdown-section">
                                <ion-icon name="server-outline" class="dropdown-icon"></ion-icon>
                                <div>
                                    <a class="dropdown-item" id="dropdown-heading" href="#">Database</a>
