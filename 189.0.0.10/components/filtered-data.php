...
if (isset($_POST['data'])) {
    ...
    if ($data_number == '1') {
        $fetch = "SELECT * FROM `user_form` WHERE `user_form_emp_id` = '$data'";
    } elseif ($data_number == '2') {
        $fetch = "SELECT * FROM `user_form` WHERE `user_form_contact` = '$data'";
    } elseif ($data_number == '3') {
        $fetch = "SELECT * FROM `user_form` WHERE `user_form_ref_number` = '$data'";
    } elseif ($data_number == '4') {
        $fetch = "SELECT * FROM `user_form` WHERE `user_form_ref_contact` = '$data'";
    }
...
?>
        <div class="container-fluid">
            <div class="go-back-container">
                <a href="leads.php"><ion-icon name="arrow-back-circle-outline"></ion-icon> Go Back</a>
            </div>
